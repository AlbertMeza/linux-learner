...
public class StringLiterals {
  ...
  public static final String CD_EXIST = ("This directory already has a file named %s\n");

  public static final String COMPUTER_PROMPT = ("Please enter your Computer Name: ");

  public static final String HELP_INVALID = ("help for that command is not available. You may use clear, ls, pwd, touch, or exit");
  ...
  public static final String HELP = ("To use the help command, 'help' must be followed by: clear, ls, pwd, touch, or exit");
